...
INSERT INTO `datawarehouse`.`usuarios` (`nombre`, `apellido`, `usuario`, `email`, `password`, `telefono`, `direccion`, `admin`) VALUES ('Dilan', 'Macias', 'dilan2803', 'dilan@correo.com', '1234', '3218666523', 'calle 33', '1');
INSERT INTO `datawarehouse`.`usuarios` (`nombre`, `apellido`, `usuario`, `email`, `password`, `telefono`, `direccion`, `admin`) VALUES ('melisa', 'bernal', 'meli', 'meli@correo.com', '1234', '3218777523', 'carrera 42', '0');
INSERT INTO `datawarehouse`.`usuarios` (`nombre`, `apellido`, `usuario`, `email`, `password`, `telefono`, `direccion`, `admin`) VALUES ('Manuel', 'tamayo', 'malejo', 'malejo@correo.com', '1234', '3218555523', 'carrera 56', '0');
...
INSERT INTO `datawarehouse`.`contactos` (`nombre`, `apellido`, `email`, `telefono`, `idregion`, `idpais`, `idciudad`, `idcompania`, `cargo`, `canal_preferido`) VALUES ('Dilan', 'Macias', 'dilan2803@correo.com', '3218666523', '1', '1', '1', '1', 'desarrollador full stack', 'whatsapp, email');
INSERT INTO `datawarehouse`.`contactos` (`nombre`, `apellido`, `email`, `telefono`, `idregion`, `idpais`,  `idciudad`, `idcompania`, `cargo`, `canal_preferido`) VALUES ('Manuel', 'Tamayo', 'samymalejo@correo.com', '3218777523', '2', '3',  '5', '2', 'Ilustrador', 'telefono');
